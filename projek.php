...
// Ambil projek dari MySQL; fallback ke JSON jika kosong
$projects = [];
$db = get_db_connection();
$res = $db->query('SELECT id, title, image FROM projects ORDER BY id DESC');
if ($res) {
...
<head>
    ...
    <title><?php echo $siteTitle; ?> · Projek</title>
...
<body>
    <div class="wrap">
        ...
        <header class="hero">
            <h1>Projek</h1>
            <p>Daftar projek yang ditambahkan via Dashboard.</p>
        </header>

        <section class="section" id="work">
            <div class="grid">
                <?php if (count($projects) === 0): ?>
                    <div class="muted">Belum ada projek.</div>
